...
function buildLocalRuntime() {
  ...
  // Normalize URL for SPA router when served from /templates/honey-garden/
...
## Major fixes
- Self-hosted JS/CSS/images/audio under \`/templates/honey-garden/assets/\`
...
async function main() {
  ...
  console.log(`  then open: http://127.0.0.1:8788/templates/honey-garden/`);
}
